...
class WorkScheduleInline(admin.TabularInline):
    model = WorkSchedule
    extra = 0  # сразу 7 строк под все дни недели
...
class MasterAdmin(admin.ModelAdmin):
    ...
    list_display = ('__str__', 'phone', 'is_active', 'services_list')
    ...
    def services_list(self, obj):
        # Благодаря prefetch_related этот цикл не делает новые запросы в БД
